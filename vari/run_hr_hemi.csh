...
# cd CCTM/scripts_var/var_1
 #cd $cwd
source /home/sinavo/pkg/cmaq/5.3/config_cmaq.csh $compiler $compilerVrsn
cd /home/sinavo/pkg/cmaq/5.3/CCTM/da_9/var

#> Set General Parameters for Configuring the Simulation
 set VRSN      = v53               #> Code Version
 set PROC      = mpi               #> serial or mpi
 set MECH      = cb6r3_ae7_aq      #> Mechanism ID
 set APPL      = hemi_h1_var         #> Application Name (e.g. Gridname)
 set ADDL      = HRNOW
 set ADDL0     = HRPAST
echo "ADDL=" $ADDL
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts_var/BLD_CCTM_${VRSN}_${compilerString}
...
#> Set Working, Input, and Output Directories
 setenv WORKDIR ${CMAQ_HOME}/CCTM/da_9/var       #> Working Directory. Where the runscript is.
 setenv OUTDIR  ${CMAQ_DATA}/cctm_hemi/hemi_h1/var9 #> Output Directory
 ...
 setenv LOGDIR  ${CMAQ_HOME}/CCTM/da_9/var     #> Log Directory Location
...
echo "if ($NEW_START == true || $NEW_START == TRUE )"
     ...
     #setenv ICFILE ICON_CH4_VAR_NASA_HEMI_regrid_20100409
     setenv ICFILE ICON_CH4_VAR_NASA_HEMI_biascorrected_0.02_20100402
    # setenv ICFILE ICON_v53_HEMI_regrid_20100413
...
echo " if ( $START_DATE != 2010-04-02 && $STTIME == 000000 )"
  ...
  set BCFILE = BCON_CH4_VAR_v53_HEMI_regrid_${YYYYMMDD}
...
#> Spatial Masks For Emissions Scaling
  ...
  if( $YEAR == 2015 ) then
      ...
      set EMISfile  = EMIS_CH4_TRACER_HEMI_20100402.nc 
